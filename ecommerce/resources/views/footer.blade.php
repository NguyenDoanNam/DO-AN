          ...
          <div class="row">
            ...
            <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
              ...
              <ul class="links">
                ...
                <li>
                  <a href="#" title="Shipment</a>">Shipment</a>
                </li>
                <li>
                  <a href="#" title="Where is my order?">Where is my order?</a>
                </li>
                <li class="last">
            ...
            <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
              ...
              <ul class="links">
                <li class="first">
                  <a href="#" title="Your Account">Your Account</a>
                </li>
                <li>
                  <a href="#" title="Information">Information</a>
                </li>
                <li>
                  <a href="#" title="Addresses">Addresses</a>
                </li>
                <li>
                  <a href="#" title="Addresses">Discount</a>
                </li>
                <li>
                  <a href="#" title="Orders History">Orders History</a>
                </li>
                <li class="last">
                  <a href="#" title=" Additional Information">Additional Information</a>
                </li>
              </ul>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-3 col-xs-12">
              ...
              <ul class="links">
                ...
                <li>
                  <a href="#" title="Suppliers">Suppliers</a>
                </li>
                <li class=" last">
                  <a href="#" title="Our stores" class="link-rss">Our stores</a>
                </li>
              </ul>
            </div>
