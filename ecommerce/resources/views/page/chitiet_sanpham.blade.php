          ...
          <div class="row">
                  ...
                  <div class="product-img-box col-sm-4 col-xs-12">
                    ...
                    <div class="product-image">
                      <div class="large-image">
                        <a href="products-images/product4.jpg" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20">
                          <img alt="product-image" src="products-images/product4.jpg"> </a>
                      </div>
                      <div class="flexslider flexslider-thumb">
                        <ul class="previews-list slides">
                          <li>
                            <a href="products-images/product6.jpg" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: 'products-images/product6.jpg' ">
                              <img src="products-images/product6.jpg" alt="Thumbnail 1">
                            </a>
                          </li>
                          <li>
                            <a href="products-images/product10.jpg" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: 'products-images/product10.jpg' ">
                              <img src="products-images/product10.jpg" alt="Thumbnail 2">
                            </a>
                          </li>
                          <li>
                            <a href="products-images/product3.jpg" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: 'products-images/product3.jpg' ">
                              <img src="products-images/product3.jpg" alt="Thumbnail 1">
                            </a>
                          </li>
                          <li>
                            <a href="products-images/product4.jpg" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: 'products-images/product4.jpg' ">
                              <img src="products-images/product4.jpg" alt="Thumbnail 2">
                            </a>
                          </li>
                          <li>
                            <a href="products-images/product5.jpg" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: 'products-images/product5.jpg' ">
                              <img src="products-images/product5.jpg" alt="Thumbnail 2">
                            </a>
                          </li>
                        </ul>
                      </div>
                    ...
                    <div class="email-addto-box">
                      ...
                      <ul class="add-to-links">
                        <li><span class="separator">|</span>
                          <a class="link-compare" href="compare.html" data-toggle="tooltip" data-placement="top" data-original-title="Add to Compare"></a>
                        </li>
                        <li>
                          <a class="link-wishlist" href="wishlist.html" data-toggle="tooltip" data-placement="top" data-original-title="Add to Wishlist"></a>
                        </li>
                      </ul>
                    </div>
                    <div class="toggle-content">
                      <div class="toggle toggle-white">
                        ...
                        <div style="display: none;" class="toggle_container tabcontent">
                          <div class="std">
                            <p>Eastland's heritage, rugged 8-inch moc toe workboot selected from our design archives and crafted from the finest components available; Genuine Vibram® Christy industrial outsole provides slip-resistance, durability and shock-absorbing
                              cushioning for all-day<span class="read-more">… <a href="#">read more</a></span></p>
                            <dl class="specs-table"> <dt>Detailing</dt>
                              <dd>Clean and polish leather shoes regularly with quality shoe care products </dd> <dt>Fabric</dt>
                              <dd>Leather leather shoes regularly with quality shoe care products. leather shoes regularly with quality shoe care products</dd> <dt>Care</dt>
                            ...
                            <p>Made from water-repellent Squall fabric, this is one tough travel bag. The efficient bag sports a cushioned shoulder strap for carrying ease. With an exterior pocket running the length of the front and secure zipper closure.
                              100% nylon with polyester base. Spot clean. Imported.</p>
                          </div>
                        </div>
                      </div>
                      <div class="toggle toggle-white">
                      ...
                      <div class="toggle toggle-white">
                        ...
                        <div style="display: none;" class="toggle_container ">
                          <div class="box-collateral box-tags">
                            <div class="tags">
                              <div id="addTagForm">
                                <div class="form-add-tags"> <label for="productTagName">Add Tags:</label>
                                  <div class="input-box">
                            ...
                            <div class="col-item">
                              ...
                              <div class="item-inner">
                                <div class="item-img">
                                  <div class="item-img-info">
                                    <a href="#" title="Sample Product" class="product-image">
                                      <img src="products-images/product4.jpg" alt="Sample Product">
                                    </a>
                                    <div class="item-box-hover">
                                      <div class="box-inner">
                                        <div class="product-detail-bnt">
                            ...
                            <div class="col-item">
                              <div class="item-inner">
                                <div class="item-img">
                                  ...
                                  <div class="item-img-info">
                                    <a href="#" title="Sample Product" class="product-image">
                                      <img src="products-images/product5.jpg" alt="Sample Product"> </a>
                                    <div class="item-box-hover">
                                      <div class="box-inner">
                                        <div class="product-detail-bnt">
                                          <a href="quick_view.html" class="button detail-bnt"><span>Quick View</span></a>
                            ...
                            <div class="col-item">
                              <div class="item-inner">
                                <div class="item-img">
                                  ...
                                  <div class="item-img-info">
                                    <a href="#" title="Sample Product" class="product-image">
                                      <img src="products-images/product2.jpg" alt="Sample Product"> </a>
                                    <div class="item-box-hover">
                                      <div class="box-inner">
                                        <div class="product-detail-bnt">
                                          <a href="quick_view.html" class="button detail-bnt"><span>Quick View</span></a>
                            ...
                            <div class="col-item">
                              <div class="item-inner">
                                <div class="item-img">
                                  <div class="item-img-info">
                                    <a href="#" title="Sample Product" class="product-image">
                                      <img src="products-images/product6.jpg" alt="Sample Product">
                                    </a>
                                    <div class="item-box-hover">
                                      <div class="box-inner">
                                        <div class="product-detail-bnt">
                            ...
                            <div class="col-item">
                              <div class="item-inner">
                                <div class="item-img">
                                  ...
                                  <div class="item-img-info">
                                    <a href="#" title="Sample Product" class="product-image">
                                      <img src="products-images/product10.jpg" alt="Sample Product"> </a>
                                    <div class="item-box-hover">
                                      <div class="box-inner">
                                        <div class="product-detail-bnt">
                                          <a href="quick_view.html" class="button detail-bnt"><span>Quick View</span></a>
                            ...
                            <div class="col-item">
                              <div class="item-inner">
                                <div class="item-img">
                                  ...
                                  <div class="item-img-info">
                                    <a href="#" title="Sample Product" class="product-image">
                                      <img src="products-images/product3.jpg" alt="Sample Product"> </a>
                                    <div class="item-box-hover">
                                      <div class="box-inner">
                                        <div class="product-detail-bnt">
                                          <a href="quick_view.html" class="button detail-bnt"><span>Quick View</span></a>
            ...
            <div class="box-collateral box-reviews" id="customer-reviews">
                      ...
                      <div class="review1">
                        <ul class="form-list">
                          <li> <label class="required" for="nickname_field">Nickname<em>*</em></label>
                            <div class="input-box">
                              <input type="text" class="input-text required-entry" id="nickname_field" name="nickname"> </div>
                          </li>
                          <li> <label class="required" for="summary_field">Summary<em>*</em></label>
                            <div class="input-box">
                              <input type="text" class="input-text required-entry" id="summary_field" name="title"> </div>
                          </li>
                        </ul>
                      </div>
                      <div class="review2">
                        <ul>
                          <li> <label class="label-wide" for="review_field">Review<em class="required">*</em></label>
                            <div class="input-box"> <textarea class="required-entry" rows="3" cols="5" id="review_field" name="detail"></textarea> </div>
                          </li>
                        </ul>
              ...
              <div class="box-reviews2">
                  ...
                  <ul>
                    <li>
                      ...
                      <div class="review">
                        ...
                        </h6> <small>Review by <span>Leslie Prichard </span>on 1/3/2014 </small>
                        <div class="review-txt"> I have purchased shirts from Minimalism a few times and am never disappointed. The quality is excellent and the shipping is amazing. It seems like it's at your front door the minute you get off your pc. I have received my purchases
                    ...
                    <li class="even">
                      ...
                      <div class="review">
                        ...
                        </h6> <small>Review by <span>Sandra Parker</span>on 1/3/2014 </small>
                ...
                <div class="actions">
                  <a class="button view-all" id="revies-button"><span><span>View all</span></span>
                  </a>
                </div>
              </div>
              <div class="clear"></div>
